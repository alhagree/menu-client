...
async mounted() {
  ...
  try {
    ...
    this.logoUrl = "https://ik.imagekit.io/idbeilkk4/menu_project/defulat_image/logo.png?updatedAt=1753026004161" || data.logoUrl; // ← لو الشعار يجي كامل من الباك احذف baseUrl
